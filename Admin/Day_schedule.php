      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
            <form action="Day_ScheduleSubmit.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <button type="submit" id="submitbutton" name="btnSubmit" class="btn btn-success">Submit</button>
                            </div>
                        </div>
                    </div>
