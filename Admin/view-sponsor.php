<?php
session_start();
$_SESSION['page_name'] = 'view_sponsers';
                                                        ...
                                                        $id=$rowMain['id'];
                                                          echo '
                                                            <tr>
                                                                ...
                                                                <td>'.$rowMain['email'].'</td>                 
                                                                <td>'.$rowMain['phone'].'</td>                 
                                                                <td>'.$rowMain['description'].'</td>                 
                                                                <td>'.$rowMain['type'].'</td>                                                                               
                                                                <td><a href="sponsor-approval.php?id='.$rowMain['id'].'" class="text-light"><button type="submit" class="btn btn-success" name="approved">Approved</button></a></td>
                                                                <td><a href="sponsor-rejected.php?id='.$rowMain['id'].'" class="text-light"><button type ="submit" class="btn btn-danger" name="rejected">Rejected</a></button></a></td>
...
<script>
    $(document).ready(function() {
        $('a[href="view-sponsor.php"]').addClass("active");
    });
    </script>
