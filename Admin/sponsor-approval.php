...
use PHPMailer\PHPMailer\PHPMailer;
    ...
    $update='UPDATE  our_sponsors SET status ="1"
    WHERE id='.$_GET['id'];
    ...
    // if(isset($row['first_name']) && isset($row['email'])){
        ...
        Email : '.$row['email'].'<br>
        Phone : '.$row['phone'].'<br>
        Message: Your Sponsorship for PEC Conference has been accepted. <br>
        
        Account details noted below<br> 
        Branch Name: HBL <br>
        Branch code: 1815 <br>
        Account No. 1815****** <br>
        
        You have to sent payment proof within 5 working days via reply this mail.<br>
        deans.conference@pec.org.pk
